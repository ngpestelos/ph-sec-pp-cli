...
[![CI](https://github.com/ngpestelos/ph-sec-pp-cli/actions/workflows/ci.yml/badge.svg)](https://github.com/ngpestelos/ph-sec-pp-cli/actions/workflows/ci.yml)
...
```bash
# Go 1.26.5+
go install github.com/ngpestelos/ph-sec-pp-cli/cmd/ph-sec-pp-cli@latest

# Or clone and build
git clone https://github.com/ngpestelos/ph-sec-pp-cli.git
cd ph-sec-pp-cli
go build -o ./ph-sec-pp-cli ./cmd/ph-sec-pp-cli
```

Prebuilt binaries (when releases exist): [GitHub Releases](https://github.com/ngpestelos/ph-sec-pp-cli/releases).
...
Generated by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press). Path A free-only. Repository: [ngpestelos/ph-sec-pp-cli](https://github.com/ngpestelos/ph-sec-pp-cli).
